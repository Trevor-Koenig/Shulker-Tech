                        ...
                        <div class="url-list" data-key="<?= $key ?>">
                            <?php foreach (array_filter(array_map('trim', explode("\n", $value))) as $url): ?>
                                <div class="url-list__row">
                                    <input type="text" class="form__input url-list__input"
                            ...
                            <?php if (empty(array_filter(array_map('trim', explode("\n", $value))))): ?>
                                <div class="url-list__row">
                                    <input type="text" class="form__input url-list__input"
                                        value="" placeholder="https://map.example.com">
                                    <button type="button" class="btn btn--danger btn--sm url-list__remove"
                                        aria-label="Remove">✕</button>
                                </div>
                            <?php endif; ?>
                        </div>
                        <button type="button" class="btn btn--ghost btn--sm url-list__add"
                            data-target="<?= $key ?>">+ Add URL</button>
                        <textarea name="settings[<?= $key ?>]" class="url-list__hidden" aria-hidden="true"><?= htmlspecialchars($value) ?></textarea>
