...
# Install dev tools and restore packages
# After this, you can run: make dev, make migration, make tailwind
# To publish images, also run: docker login
setup:
	dotnet tool install --global dotnet-ef || dotnet tool update --global dotnet-ef
	dotnet restore ShulkerTech.Web/ShulkerTech.Web.csproj
...
publish:
	docker build --no-cache -t $(DOCKER_USER)/shulker-tech:latest -f ShulkerTech.Web/Dockerfile .
